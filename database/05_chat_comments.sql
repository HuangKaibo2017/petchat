...
COMMENT ON COLUMN public.t_chat_history.f_pet_id         IS 'FK -> public.t_pet(f_id) | defined in 03_pet_profile.sql | 弱关联 (可空); 宠物删除时应用层通过 f_session_uid 关闭会话, 而非 FK SET NULL';
