-- ============================================================
-- Gengdongta (更懂它) / 1. 基础枚举层 / Foundation Enums
-- ============================================================
-- Version: 4.0.0
-- Created: 2026-06-17
...
--   07_cms.sql                   -> t_activity_type / t_status / t_lang
--   08_subscription.sql          -> t_plan_type / t_payment_status / t_subscription_type / t_status
...
COMMENT ON COLUMN public.t_session_status.f_name      IS '多语言名称 | 引用方: t_chat_history.f_status_session (in 05_chat_comments.sql)';
...
COMMENT ON COLUMN public.t_share_channel.f_is_active IS '启用开关';
...
COMMENT ON COLUMN public.t_health_level.f_is_active IS '启用开关';
...
COMMENT ON COLUMN public.t_activity_type.f_is_active IS '启用开关';
...
COMMENT ON COLUMN public.t_subscription_type.f_is_active IS '启用开关';
