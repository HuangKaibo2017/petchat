...
--   -> 11_agent -> 12_healthcare -> 13_welfare -> 14_wechat_payment -> 99_indexes_views
--
-- 注意事项:
...
\echo 'Step 1/16: 00_extensions.sql'
\i 00_extensions.sql
\echo 'Step 2/16: 01_enums.sql'
\i 01_enums.sql
\echo 'Step 3/16: 02_rbac_users.sql'
\i 02_rbac_users.sql
\echo 'Step 4/16: 03_pet_profile.sql'
\i 03_pet_profile.sql
\echo 'Step 5/16: 04_ai_reports.sql'
\i 04_ai_reports.sql
\echo 'Step 6/16: 05_chat_comments.sql'
\i 05_chat_comments.sql
\echo 'Step 7/16: 06_share_interpretation.sql'
\i 06_share_interpretation.sql
\echo 'Step 8/16: 07_cms.sql'
\i 07_cms.sql
\echo 'Step 9/16: 08_subscription.sql'
\i 08_subscription.sql
\echo 'Step 10/16: 09_ecommerce.sql'
\i 09_ecommerce.sql
\echo 'Step 11/16: 10_iot.sql'
\i 10_iot.sql
\echo 'Step 12/16: 11_agent.sql'
\i 11_agent.sql
\echo 'Step 13/16: 12_healthcare.sql'
\i 12_healthcare.sql
\echo 'Step 14/16: 13_welfare.sql'
\i 13_welfare.sql
\echo 'Step 15/16: 14_wechat_payment.sql'
\i 14_wechat_payment.sql
\echo 'Step 16/16: 99_indexes_views.sql'
